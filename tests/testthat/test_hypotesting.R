...
testthat::test_that("ttest", {
  ...
  ttestLs <- .twoSampCorTests(
    data.mn = t(assay(sacurine.se)),
  ...
  sacurine.se <- hypotesting(sacurine.se,
    test.c = "ttest",
    factor_names.vc = "gender",
    factor_levels.ls = list(factor1 = c(
      "Male",
      "Female"
    )),
    figure.c = "none",
...
testthat::test_that("anova2ways", {
  ...
  metabo.se <- transforming(metabo.se)


  ## .anova2ways
  anova2ways.ls <- .anovas2ways(
    data.mn = t(assay(metabo.se)),
  ...
  testthat::expect_error(.anovas2ways(
    data.mn = t(assay(metabo.se)),
    samp.df = colData(metabo.se),
    feat.df = rowData(metabo.se),
    test.c = "anova2ways",
