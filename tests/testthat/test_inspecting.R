...
testthat::test_that("inspecting-se", {
  ...
  proteo.se <- transforming(proteo.se)
...
#   sacurine.eset <- reading(
#     system.file("extdata/sacurine",
#       package = "phenomis"
#     ),
#     output.c = "set"
#   )
...
#   proteo.eset <- reading(
#     system.file("extdata/prometis/proteo",
#       package = "phenomis"
#     ),
#     output.c = "set"
#   )
...
#   prometis.mset <- reading(
#     system.file("extdata/prometis",
#       package = "phenomis"
#     ),
#     output.c = "set"
#   )
...
#   testthat::expect_equivalent(
#     Biobase::pData(prometis.mset)[["metabo"]][
#       "L824m",
#       "hotel_pval"
#     ],
#     0.34770846,
